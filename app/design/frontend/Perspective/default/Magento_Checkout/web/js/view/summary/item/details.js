...
define([
    ...
    'mage/collapsible',
    'mage/cookies'
], function ($, Component, escaper, authenticationPopup, customerData, quote, getTotalsAction, shippingService, rateRegistry, resourceUrlManager, storage, errorProcessor, url,alert, confirm, _) {
    'use strict';
    ...
    return Component.extend({
        ...
        updateItemQtyCheckout: function (data, event)
        {
            ...
            let itemId = event.currentTarget.dataset.cartItem;
            ...
            {
                let productData = this._getProductById(Number(itemId));

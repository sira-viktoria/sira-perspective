...
return [
    'modules' => [
        ...
        'Perspective_CheckoutCustomization' => 1,
        ...
        'Perspective_ErpImport' => 1,
        'Perspective_LiqPay' => 1,
        'Perspective_MultiTabProductWidget' => 1,
        'Perspective_MyPay' => 1,
        'Perspective_NovaposhtaCatalog' => 0,
        'Perspective_NovaposhtaShipping' => 0,
        'Perspective_SoldTodayWidget' => 1,
        'Perspective_TabbedWidget' => 1,
        'Perspective_WeatherRecommendations' => 1,
        'Perspective_WeatherInsurance' => 1
    ]
];
